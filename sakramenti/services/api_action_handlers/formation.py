...
def create_confirmation_year(parish_data: dict, action_payload: dict) -> dict:
    ...
    if confirmation_group['groupFeePaid']:
...
def create_first_communion_year(parish_data: dict, action_payload: dict) -> dict:
    ...
    first_communion_group = {
        ...
        'groupFee': float(action_payload.get('group_fee') or 0),
        'groupFeePaid': bool(action_payload.get('group_fee_paid')),
        'candidates': [],
    }
    if first_communion_group['groupFeePaid']:
