...
(function (global) {
  ...
  function applyThemeVars(opts) {
    ...
    root.style.setProperty("--surface-elevated", opts.surfaceElevated || "#fffdf9");
    root.style.setProperty("--primary-rgb", `${r}, ${g}, ${b}`);
    root.style.setProperty("--primary-soft", `rgba(${r}, ${g}, ${b}, 0.08)`);
    ...
    root.style.setProperty("--shadow", `0 8px 32px rgba(${r}, ${g}, ${b}, 0.08)`);
    root.style.setProperty("--shadow-lg", `0 16px 48px rgba(${r}, ${g}, ${b}, 0.12)`);
    root.style.setProperty("--border-tint", `color-mix(in srgb, ${primary} 12%, var(--border-base, #e3dcd2))`);
  ...
  function saveTheme(partial) {
    ...
    P.saveSettings({
      ...cur,
      ...partial,
      customTheme: partial.customTheme ?? partial.primaryColor != null,
    });
    applyFromSettings(P.loadSettings());
  }
