...
from liturgija.services.liturgical_hilp import fetch_hilp_day, hilp_url
from liturgija.services.liturgical_deep import translate_reading_ref, translate_to_hr
from liturgija.services.liturgical_translate import (
    translate_liturgical_name,
    translate_season_lcl,
)
from liturgija.services.liturgical_imports import load_imported_calendar_events
...
def _load_events(year: int) -> list:
    ...
    from liturgija.litcal_fixture_data import litcal_events_for_year

    fixture_events = litcal_events_for_year(year)
    if fixture_events:
        logger.info('LitCal %s iz ugrađenog fixturea', LITCAL_NATION)
